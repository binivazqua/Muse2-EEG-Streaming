...
def main():
    my_survey = CualitativeSurvey(filename="prueba_5_estudiando_babyblue", p_id="001")
    my_survey.init_csv()
    ...
    my_eeg = EEGRecorder(duration=20, filename="prueba_5_eeg_estudiandobabyblue", r_id="001")
